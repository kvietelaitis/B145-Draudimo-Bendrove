...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./var/www/html/draudimo-bendrove/public/storage' => 'string',
...
'filesystems.disks.s3.report','filesystems.links./var/www/html/draudimo-bendrove/public/storage','logging.default','logging.deprecations.channel','logging.deprecations.trace',
...
'web','api',);
        registerArgumentsSet('routes', 'home','login',
'logout','register','storage.local',);
        registerArgumentsSet('views', 
'auth.login','auth.register','home','layouts.app','welcome',
